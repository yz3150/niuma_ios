...
String _currentMessage = "开始摸鱼，收入马上到账！";
...
String getRandomRestEarningMessage(double restEarning) {
  ...
  // 2. 收入档位发生变化
  // 3. 还没有设置过文案（第一次调用）
  if (minutesSinceLastUpdate >= 5 || currentThreshold != _lastThreshold || _currentMessage == "开始摸鱼，收入马上到账！") {
    // 如果没有匹配到任何档位，返回默认文案
    if (currentThreshold == null) {
      _currentMessage = "开始摸鱼，收入马上到账！";
    } else {
      // 从对应档位的文案列表中随机选择一条
